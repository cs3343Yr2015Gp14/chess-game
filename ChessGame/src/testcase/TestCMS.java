...
public class TestCMS extends TestCase{
	...
	@Test
	public void testInitializeAndGetChessPieceRook() {
		//set players
		int numOfPlayer=2;
	...
	@Test
	public void testInitializeAndGetChessPieceKnight() {
		//set players
		int numOfPlayer=2;
		ChessPlayer[] players=new ChessPlayer[numOfPlayer];
		for (int i=0;i<numOfPlayer;i++){
	...
	@Test
	public void testInitializeAndGetChessPieceBishop() {
		//set players
		int numOfPlayer=2;
		ChessPlayer[] players=new ChessPlayer[numOfPlayer];
		for (int i=0;i<numOfPlayer;i++){
	...
	@Test
	public void testInitializeAndGetChessPieceKing() {
		//set players
		int numOfPlayer=2;
		ChessPlayer[] players=new ChessPlayer[numOfPlayer];
		for (int i=0;i<numOfPlayer;i++){
	...
	@Test
	public void testInitializeAndGetChessPieceQueen() {
		//set players
		int numOfPlayer=2;
		ChessPlayer[] players=new ChessPlayer[numOfPlayer];
		for (int i=0;i<numOfPlayer;i++){
	...
	@Test
	public void testInitializeAndGetChessPieceBishop2() {
		//set players
		int numOfPlayer=2;
		ChessPlayer[] players=new ChessPlayer[numOfPlayer];
		for (int i=0;i<numOfPlayer;i++){
	...
	@Test
	public void testInitializeAndGetChessPieceKnight2() {
		//set players
		int numOfPlayer=2;
		ChessPlayer[] players=new ChessPlayer[numOfPlayer];
		for (int i=0;i<numOfPlayer;i++){
	...
	@Test
	public void testInitializeAndGetChessPieceRook2() {
		//set players
		int numOfPlayer=2;
		ChessPlayer[] players=new ChessPlayer[numOfPlayer];
		for (int i=0;i<numOfPlayer;i++){
